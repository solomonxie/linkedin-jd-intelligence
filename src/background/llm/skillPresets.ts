...
export const SKILL_PRESETS: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      {
        skill: "multi-tenancy",
        implies: ["tenant data isolation", "row-level security", "scalable SaaS architecture"],
      },
    ],
  },
  {
    ...
    skills: [
      ...
      { skill: "HIPAA", implies: ["data privacy compliance", "healthcare data handling"] },
      { skill: "PCI-DSS", implies: ["payment data handling", "encryption at rest/in transit"] },
    ],
  },
  {
